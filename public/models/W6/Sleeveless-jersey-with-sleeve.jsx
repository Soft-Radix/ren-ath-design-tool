...
Command: npx gltfjsx@6.2.16 sleeveless-jersey-with-sleeve.glb 
*/
...
export function Model(props) {
  const { nodes, materials } = useGLTF(
    "./models/W6/sleeveless-jersey-with-sleeve.glb"
  );
  return (
...
useGLTF.preload("./models/W6/sleeveless-jersey-with-sleeve.glb");
