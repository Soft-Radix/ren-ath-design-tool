...
export function Model(props) {
  // model intialised using useGLTF hook
  const { nodes, materials } = useGLTF("./models/W3/long-sleeve-jersey2.glb");
  // Set Camera Position
    ...
    if (modelRef.current) {
      ...
      const createMaterial = (
        ...
        const uniforms = {
          ...
          designGradientscale: { value: designGradientscale ?? 0.8 },
  ...
  uniform float designGradientscale;
  ...
  void main() {
    ...
    if (isPrimaryGradient) {
      ...
      float gradientPosition = smoothstep(dynamicGradientStart * designGradientscale, 0.75 * designGradientscale, rotatedUvPrimary.y);
...
`,
      ...
      modelRef.current.children.forEach((child, index) => {
        if (child.isMesh) {
          ...
          const gradientscale =
            index == 7 || index == 6
              ? gradientScale[index] + 0.5
              : gradientScale[index];
          const designGradientscale = designScale[index];
          ...
          const dynamicGradientStart = index === 6 || index === 7 ? 1.0 : 0.15;
      ...
      <group {...props} dispose={null}>
        ...
        >
          ...
          <mesh
            ...
            material={materials["Default (6) (1)"]}
            name="Front Side"
          >
            {number[2] && (
              <Decal
...
useGLTF.preload("/long-sleeve-jersey2.glb");
